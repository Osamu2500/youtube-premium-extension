# Graph Report - Youtube 2.0  (2026-05-01)

## Corpus Check
- 110 files · ~120,976 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1685 nodes · 3530 edges · 76 communities detected
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 454 edges (avg confidence: 0.8)
...
- `1247()` --calls--> `ul()`  [INFERRED]
  Temporary\settings.js → Temporary\popup.js
- `1247()` --calls--> `Rl()`  [INFERRED]
  Temporary\settings.js → Temporary\popup.js
- `1247()` --calls--> `wd()`  [INFERRED]
  Temporary\settings.js → Temporary\popup.js
- `_hideDistractions()` --calls--> `toggle()`  [INFERRED]
  src\content\features\pages\watch\focus-mode.js → src\content\utils.js
- `_applyComputedFilter()` --calls--> `S()`  [INFERRED]
  src\content\features\player\video-filters\video-filters.js → Temporary\settings.js

## Communities

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (222): 104(), 1042(), 1175(), 1331(), 1380(), 1420(), 1489(), 1549() (+214 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (118): 9869(), A(), dispatch(), ie(), ae(), applyPatches(), at(), be() (+110 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (95): 1247(), 4477(), 4848(), 5072(), 5143(), 5160(), 5338(), 6221() (+87 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (69): 1247(), 1459(), 2224(), 289(), 3605(), 3862(), 4509(), 5749() (+61 more)
...
Cohesion: 0.13
Nodes (13): An, Dn(), gs(), hs(), Ii(), is(), Pn(), ss() (+5 more)
...
## Knowledge Gaps
- **1 isolated node(s):** `Main execution function.          Returns:         int: Exit code (0 for succ`
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 38`** (12 nodes): `ElementCache`, `.clear()`, `.constructor()`, `.destroy()`, `.get()`, `.getAll()`, `.getStats()`, `.has()`, `.remove()`, `.set()`, `.watch()`, `element-cache.js`
...
- **Thin community `Community 44`** (11 nodes): `SearchRedesign`, `.constructor()`, `.disable()`, `.enable()`, `.getConfigKey()`, `._handleNavigation()`, `.init()`, `._log()`, `._removeClasses()`, `.run()`, `search-redesign.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 50`** (9 nodes): `NightModeManager`, `._applyBlueLight()`, `._applyDim()`, `.constructor()`, `._createBlueLightFilter()`, `.getConfigKey()`, `._removeBlueLight()`, `.run()`, `night-mode.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 71`** (6 nodes): `clear()`, `constructor()`, `emit()`, `on()`, `once()`, `event-bus.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 75`** (5 nodes): `subs-ui-filter.js`, `_filterFeedNow()`, `injectFilterBar()`, `reapplyFilters()`, `renderFilterBar()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 78`** (3 nodes): `main()`, `example_script.py`, `Main execution function.          Returns:         int: Exit code (0 for succ`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `S()` connect `Community 1` to `Community 2`, `Community 36`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `1247()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 5`, `Community 8`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `_applyComputedFilter()` connect `Community 36` to `Community 1`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
...
- **What connects `Main execution function.          Returns:         int: Exit code (0 for succ` to the rest of the system?**
