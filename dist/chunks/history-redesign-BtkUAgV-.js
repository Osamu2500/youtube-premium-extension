window.YPP.features.HistoryRedesign=class extends window.YPP.features.BaseFeature{constructor(){super("HistoryRedesign"),this.styleElement=null,this.currentCalDate=new Date,this.selectedCalDateString=null,this._boundHandleMutations=this.handleMutations.bind(this)}getConfigKey(){return"historyRedesign"}async enable(){var t;if(location.pathname==="/feed/history"){await super.enable();try{this.apply(),this.observer.start(),this.observer.register("history-redesign","ytd-app",this._boundHandleMutations,!1)}catch(e){(t=this.utils)==null||t.log("Error enabling HistoryRedesign","HISTORY","error",e)}}}async disable(){await super.disable(),this.observer&&(this.observer.unregister("history-redesign"),this.observer.stop()),this.styleElement&&(this.styleElement.remove(),this.styleElement=null)}apply(){this.injectStyles(),typeof this.injectCalendarModal=="function"&&this.injectCalendarModal()}injectStyles(){if(document.getElementById("ypp-history-grid-styles"))return;const t=`
            /* ==========================================================================
        ...
        `;this.styleElement=document.createElement("style"),this.styleElement.id="ypp-history-grid-styles",this.styleElement.textContent=t,document.head.appendChild(this.styleElement)}handleMutations(){location.pathname==="/feed/history"&&this.apply()}};
